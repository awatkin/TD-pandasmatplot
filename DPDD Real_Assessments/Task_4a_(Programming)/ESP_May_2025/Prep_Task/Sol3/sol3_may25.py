...
# This is the solution to Task 1, Task 2 AND Task 3
# The tasks are:
...
def menu():
    ...
    while flag:
        ...
        main_menu_choice = input("Please enter the number of your choice (1-4): ")  # updated this line to accomodate further than option 2
        ...
        try:
            ...
            if int(main_menu_choice) < 1 or int(main_menu_choice) > 4:  # further updated this to allow higher than 2
                print("Sorry, you did not enter a valid choice")
                flag = True
            else:
