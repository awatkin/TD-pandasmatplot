...
# This is the solution to Task 1, Task 2, Task 3 AND  Task 4
# The tasks are:
...
def menu():
    ...
    while flag:
        ...
        main_menu_choice = input("Please enter the number of your choice (1-5): ")  # updated this line to accomodate further than option 2
        ...
        try:
            ...
            if int(main_menu_choice) < 1 or int(main_menu_choice) > 5:  # further updated this to allow higher than 2
                print("Sorry, you did not enter a valid choice")
                flag = True
            else:
...
def region_issue():  # New subroutine to solve task 3
    ...
    issue_count.plot.bar()  # sets the total issue per region to a chart
    plt.title("Total Issues Per Region")  # sets the title
