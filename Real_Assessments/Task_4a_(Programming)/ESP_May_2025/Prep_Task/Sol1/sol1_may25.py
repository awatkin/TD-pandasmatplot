...
def menu():
    ...
    while flag:
        ...
        print("2. Issue Numbers and rating")  # updated this line to accomodate task 1 option
        ...
        try:
            ...
            if int(main_menu_choice) < 1 or int(main_menu_choice) > 2:  # Updated this to allow higher than 1
                print("Sorry, you did not enter a valid choice")
                flag = True
            else:
